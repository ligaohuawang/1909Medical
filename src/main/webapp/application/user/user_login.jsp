...
<section class="DoctorMain Main">
    <div class="dl-title"><a href="index.html">会员登录</a></div>
    <div class="dl-bg">
        <table class="">
            <tr>
            ...
            <tr>
                <td><span>密码:</span><input type="password" class="text" name="upassword" /></td>
            </tr>
            <tr>
                <td><span>验证码:</span><input type="text" class="text text2"  name="code" />
                    <input type="button" value="看不清" onclick="notClear()"/>
                    <img id="checkCode" src="check/code?r="+new Date()  onclick="notClear()"/>
                </td>
            </tr>
            <tr>
                <td><input type="button" class="button1" value="确定"/><a class="zuce" href="application/user/user_regist.jsp">注册</a><em>|</em><a class="mima" href="application/user/user_forget.jsp">忘记密码？</a></td>
            </tr>
        </table>
    </div>
</section>
...
<script type="text/javascript">
    ...
    $(".button1").click(function() {
        ...
        $.ajax({
            url:"user/login3",
            type:"GET",
            data:"nicknane="+uname+"&upassword="+upassword+"&code="+code,
    ...
    function notClear() {
        document.getElementById("checkCode").src="check/code?r="+new Date();
    }
