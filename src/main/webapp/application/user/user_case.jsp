    ...
    <div class="conbox">
        <div class="siderMem">
            <ul>
                ...
                <li><a href="user/selDiagnosis" class="a6">会诊信息</a></li>
                <li class="on"><a href="user/selCase" class="a8">历史病历</a></li>
            </ul>
        </div>
        ...
        <div class="mainCont">
            ...
            <c:forEach var="pa" items="${page.list}">
            <div class="bookBox2 Dt">
                ...
                <div class="book-table">
                    ...
                    <c:forEach items="${pa.tmList}" var="kk">
                    <div class="line1">
                        <span class="sp1">既往病例</span>
                        <span class="sp2"></span>
                        <span class="sp3"></span>
                        <span class="sp4"></span>
                    </div>
                    <div class="line1">
                        <span class="sp1">所患疾病：<em>${kk.hname}</em></span>
                        <span class="sp2">治疗方式：<em>${kk.hhow}</em></span>
                        <span class="sp3">治疗医院：<em>${kk.hhospital}</em></span>
                        <span class="sp4">主治医师：<em>${kk.hdoctor}</em></span>
                    </div>
                    </c:forEach>
            ...
            <jsp:include page="/application/commons/page.jsp">
                <jsp:param name="bodyId" value="caseBody"></jsp:param>
            </jsp:include>
        </div>
        <!--右边内容 end-->
    </div>
