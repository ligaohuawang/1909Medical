  ...
  <section class="MemberMain Main">
    ...
    <div class="siderMem">
      <ul>
          ...
          <li  class="on"><a href="application/user/change_password.jsp" class="a2">密码修改</a></li>
    ...
    <!--start-->
     <div class="password-box">
        <table class="table2">
               <tr>
                 <td><span>原密码:</span><input type="text" class="text" name="upassword" /></td>
               </tr>
               
               <tr>
                 <td><span>新密码:</span><input type="text" class="text" name="upassword2"/></td>
               </tr>
               
               <tr>
                 <td><span>新密码确认:</span><input type="text" class="text"  name="upassword3"/></td>
               </tr>
               <tr>
                 <td><input type="button" class="button1"  value="修改"/><input type="button" class="button2" value="重置" /></td>
               </tr>
          </table>
...
$("input[name=upassword]").blur(function () {
    ...
    $.ajax({
        ...
        success:function (data) {
            if(!data.result){
                layer.msg("密码有误",{icon:5,time:1000});
            }
        }
    })
})

     $("input[name=upassword3]").blur(function () {
         var upassword2 = $("input[name='upassword2']").val();
         var upassword3 = $("input[name='upassword3']").val();

         if(''==upassword3){
             layer.msg("请确认新密码",{icon:5,time:1000});
             return
         }
         if(upassword2 != upassword3){
             layer.msg("新密码不一致",{icon:5,time:1000});
             return
         }
     })
...
if(a==true){
    $.ajax({
        ...
        data:"upassword="+upassword2,
        success:function (data) {
            if(data.result){
                layer.msg("修改成功",{icon:6,time:1000}),function () {
                    $("input[name='upassword']").val("");
                    $("input[name='upassword2']").val("");
                    $("input[name='upassword3']").val("");
                };
            }else {
