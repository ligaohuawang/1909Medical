    ...
    <div class="conbox">
        <div class="siderMem">
            <ul>
                ...
                <li class="on"><a href="zxorder/selectByContent" class="a5">咨询订单</a></li>
                ...
                <div class=" templet_jobs_005 ">
                    ...
                    <div class="bookcontent">
                        ...
                        <ul style="display: block;">
                            ...
                            <div class="clear"></div>
                            <!--从这里循环-->
                            <c:forEach items="${page.list}" var="zxorder">
                                <li>
                                    <div class="carbox">
                                        <div class="sp6">
                                            <a class="status-list" data="取消" rel="100451693" href="advice/payment?xmprice=${zxorder.xmprice}&zxoid=${zxorder.zxoid}" style=" cursor:pointer;">支付</a></div>

                                        <div class="sp5"><span>${zxorder.ostate =='1'?"支付成功":"取消支付"}</span><span>${zxorder.cancel =='1'?"确认订单":"取消订单"}</span></div>

                                        <div class="sp2"><fmt:formatDate value="${zxorder.createtime}" type="date"/></div>
                                        <div class="sp2">
                                            <span>${zxorder.xmprice}</span>
                                        </div>
                                        <div class="sp2"><span>${zxorder.dname}</span></div>
                                        <div class="sp1">
                                            <h6 class="h6"><a href="#">${zxorder.xmname}</a></h6>
                                        </div>
                                        <div class="sp0"><span>${zxorder.zxoid}</span></div>
                                    </div>
                                </li>
                            </c:forEach>
                            <!--从这里循环end-->
