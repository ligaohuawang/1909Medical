    ...
    <div class="conbox">
        <div class="siderMem">
            <ul>
                ...
                <li class="on"><a href="productOrder/selectOrderFromProductOrderByUid" class="a3">商品订单</a></li>
        ...
        <div class="mainCont">
            ...
            <div class="bookBox Dt">
                ...
                <div class=" templet_jobs_004 ">
                    <nav class="Category2">
                        <ul>
                            <li value="" class="lion on" >全部</li>
                            <li value="1" class="lion" >支付成功</li>
                            <li value="2" class="lion" >等待支付</li>
                        </ul>
                    </nav>
                    ...
                    <div class="bookcontent">
                        ...
                        <ul style="display: block;">
                            ...
                            <li>
                                <div class="carbox">
                                    <div class="sp6">
                                        <a href="orderDetail/selectAllfromOrderDetailByOrderNumber?orderNumber=${productOrder.orderNumber}"style=" cursor:pointer;">查看</a><%--根据订单编号查询详情表该订单下所有商品--%>
                                        <a class="status-list" data="取消" rel="100451693" href="productOrder/pay?orderNumber=${productOrder.orderNumber}" style=" cursor:pointer;">支付</a></div><%--直接拿到金额？--%>
                                    <div class="sp5"><span>${productOrder.orderStatus =='1'?"已支付":"未支付"}</span><a href="#">跟踪</a></div>
                                    <div class="sp4"><span><fmt:formatDate value="${productOrder.createTime}" type="date"/></span></div>
                                    <div class="sp3">
                                        <span>￥${productOrder.orderPrice}</span>
                                    </div>
                                    <div class="sp2"><span>${productOrder.shouhuoren}</span></div>
                                    <div class="sp0"><span>${productOrder.orderNumber}</span></div>
                                </div>
                            </li>
                            </c:forEach>
                            <!--从这里循环end-->
