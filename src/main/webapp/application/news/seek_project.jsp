...
<aside class="banner ban" style=" background:url(uploadfiles/h01.jpg) no-repeat top center; height:210px;">
    <div class="banlink">
        <a href="application/news/seek_login.jsp" class="a1">会员登录</a>
        <a href="doctor/queryDoctorList?dspeciality=会诊医生&currentPage=1&pageSize=4" class="a2">名医推荐</a>
...
<section class="DoctorMain Main">
    ...
    <div class="conbox">
        ...
        <div class="siderDoc">
            <ul>
                <li><a href="application/news/seek_login.jsp">注册/登录</a></li>
                <dl><img src="images/docsider-coin.png"></dl>
                <li class="on"><a href="javascript:void(0)">选择咨询项目</a></li>
                <dl><img src="images/docsider-coin.png"></dl>
        ...
        <div class="mainCont">
            <div class="contDoc">
                <ul>
                    <c:forEach var="ti" items="${timerList}">
                    <li class="project"><a href="javascript:void(0)">${ti.xmname}</a></li>
                        <input type="hidden" value="${ti.xmprice}">
                    </c:forEach>
                </ul>
                <!--*pages*-->
    ...
    $("#continue").click(function () {
        ...
        if ( hiuser != ""){
            ...
            if (selection.length != 1){
                ...
                var xmname = $("#selection").text();
                var xmprice = $("#selection").next().val();
                location.href="advice/doctr?xmname="+xmname+"&xmprice="+xmprice;
            }
        }else{

            layer.msg('您还没有登陆，请先登陆',{icon:5,time:2000},function () {
                location.href="application/news/seek_login.jsp";
            })
        }
    });
