    ...
    <div class="conbox">
        ...
        <div class="siderDoc">
            <ul>
                ...
                <dl><img src="images/docsider-coin.png"></dl>
                <li class="on"><a href="javascript:void(0)">订单支付</a></li>
                <dl><img src="images/docsider-coin.png"></dl>
        ...
        <div class="mainCont">
            <!--start-->
            <div class="orderDoc">
                <input type="hidden" value="${tZxorder.zxoid}" id="orderId">
                <h4><span>订单金额：</span></h4>
                <p>共计：<span>${tZxorder.xmprice}</span>元</p>
                <h4><span>支付方式：</span></h4>
                <a class="payimg" href="#"><img src="images/doctor_pay_icon.jpg" /></a>
                <div><a href="javascript:void(0)" style="display:inline"><input type="button" value="确认支付" id="confirm"></a>
                    <a href="javascript:void(0)" style="display:inline"><input type="button" value="取消支付" id="cancel"></a></div>
            </div>
...
<script type="text/javascript">
    ...
    $("#confirm").click(function () {
        var  oid = $("#orderId").val();
        var con = "confirm";
        layer.confirm('你确认支付吗?',{icon:3,title:'提示'},function (index) {
            location.href="advice/order?tidings="+con+"&zxoid="+oid;
            layer.close(index);
        });
    ...
    $("#cancel").click(function () {
        var  oid = $("#orderId").val();
        var  can = "cancel";
        layer.confirm('你确定取消支付吗?',{icon:3,title:'提示'},function (index) {
            location.href="advice/order?tidings="+can+"&zxoid="+oid;
            layer.close(index);
        });
