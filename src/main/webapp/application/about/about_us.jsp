...
<script  type="text/javascript"> var navid="6"</script>
</head>
...
function CheckString(s) {
  ...
  <!--图片切换 End-->	
  <aside class="Current"><em></em><a href="index.html">首页</a> > <span>关于我们</span></aside>
  
  <section class="AboutMain Main">
    <ul class="cate">
      <li class="on first"><a href="#" class="a1">品牌背景</a></li>
      <li ><a href="#" class="a2">公司背景</a></li>
      <li ><a href="#" class="a3">销售渠道</a></li>
