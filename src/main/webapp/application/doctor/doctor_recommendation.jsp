...
function CheckString(s) {
  ...
  <section class="MemberMain Main">
    ...
    <div class="siderFamous">
      <ul>
        <li class="licla <c:if test="${dspeciality == '会诊医生' || dspeciality == null}" >on </c:if> " value="1"> <a href="javascript:void(0)" class="a1">会诊医生</a> </li>
       
        <li class="licla <c:if test="${dspeciality == '保健医生'}">on </c:if> "  value="2"> <a href="javascript:void(0)" class="a2">保健医生</a> </li>

        <li class="licla <c:if test="${dspeciality == '专科医生'}">on </c:if> " value="3"> <a href="javascript:void(0)" class="a3">专科医生</a> </li>
   
        <li class="licla <c:if test="${dspeciality == '专家医生'}">on </c:if> " value="4"> <a href="javascript:void(0)" class="a4">专家医生</a> </li>
      </ul>
    </div>
    ...
    <div class="mainCont">
     ...
     <!--start-->
      <div class="famous-title">
        <h3><span>${doctor.dspeciality}</span></h3>
      </div>
      <div class="doctor-list">
        <ul>
            <c:forEach items="${page.list}" var="doctor">
              <li>
                <a class="imgBox" href="doctor/querydetail?did=${doctor.did}"><img src="${doctor.dpicture}"></a>
      ...
      <!--*pages*-->
        <jsp:include page="/application/commons/page.jsp">
            <jsp:param name="bodyId" value="doctor-list"></jsp:param>
        </jsp:include>
               <!--*pages*-->
    </div>
    <!--右边内容 end-->
  ...
  <script type="text/javascript">
     ...
     $(".licla").click(function () {
         ...
         $("#doctor-list").load( "doctor/queryDoctorList?currentPage=1&pageSize=4&dspeciality="+dspeciality);
