  ...
  <section class="DoctorMain Main">
     <div class="dl-title"><a href="index.html">会员登录</a></div>
      <div class="dl-bg">
         <table class="">
               <tr>
                 <td><span>用户名:</span><input type="text" class="text" name="dname"/></td>
               </tr>
               <tr>
                  <td><span>密码:</span><input type="text" class="text" name="dpassword"/></td>
               </tr>
              <tr> 
                <td><span>验证码:</span><input type="text" class="text text2" name="verification" /><a class="yzm" href="#"></a></td>
              </tr>
              
              <tr>
                <td><input type="button" class="button1" value="确定"/><a class="zuce" href="#">注册</a><em>|</em><a class="mima" href="#">忘记密码？</a></td>
              </tr>
          </table>
      </div>
  </section>
